...
import com.jkky98.spubg.discord.domain.ClutchDealtRanking;
...
public class ClutchDealtCommand implements Command {
    ...
    public void execute(MessageReceivedEvent event, String[] args) {
        List<ClutchDealtRanking> clutchDealtRankings = staticMapper.getClutchDealtRankings();
        messageResponseService.sendClutchDealtRanking(event, clutchDealtRankings);
    }
}
